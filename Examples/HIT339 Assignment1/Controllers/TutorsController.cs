...
namespace HIT339_Assignment1.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public TutorsController(HIT339_Assignment1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Email,PhoneNumber")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,PhoneNumber")] Tutor tutor)
        {
            if (id != tutor.Id)
            {
                return NotFound();

...
namespace AssignmentOne_CYCC.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public InstrumentsController(AssignmentOne_CYCCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Family")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Family")] Instrument instrument)
        {
            if (id != instrument.Id)
            {
                return NotFound();

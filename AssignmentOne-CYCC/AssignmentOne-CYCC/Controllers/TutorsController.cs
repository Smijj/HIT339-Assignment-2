...
namespace AssignmentOne_CYCC.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public TutorsController(AssignmentOne_CYCCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,fName,lName,Email,PhoneNumber")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,fName,lName,Email,PhoneNumber")] Tutor tutor)
        {
            if (id != tutor.Id)
            {
                return NotFound();
